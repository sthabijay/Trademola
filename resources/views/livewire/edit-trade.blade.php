<div class="h-full flex justify-center items-center max-w-3xl mx-auto">
    <form wire:submit.prevent="save" class="flex flex-col bg-white w-full p-8 gap-2 rounded-xl border-2 border-gray-100">
        <h1 class="text-2xl">Edit Trade Entry</h1>
        ...
        <div class="flex justify-end gap-2">
            ...
            <input type="submit" value="Edit Entry" class="bg-blue-500 p-2 w-48 mt-4 rounded-xl cursor-pointer text-white border-2 border-blue-500 hover:border-blue-200 transition-all">
        </div>
        <!-- Submit Button -->
    </form>
</div>
